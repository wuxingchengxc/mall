...
--
-- Host: 127.0.0.1    Database: mall_pms
-- ------------------------------------------------------
...
INSERT INTO `pms_attr` VALUES (2,'测试使用',1,'xxx','1,2,3',0,1,165,1),(4,'测试3',1,'xxx','1,2,3',0,1,165,1);
...
CREATE TABLE `pms_attr_attrgroup_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='属性&属性分组关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_attr_attrgroup_relation` VALUES (2,4,21,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='属性分组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_attr_group` VALUES (17,'asd',NULL,'asdda',NULL,NULL),(18,'12312',NULL,'1231',NULL,NULL),(20,'哈哈哈',NULL,'是大多数',NULL,165),(21,'书本类型',NULL,'嗷嗷',NULL,165);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='品牌';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_brand` VALUES (2,'小米','http://127.0.0.1:11032/statics/2024/04/28/1680501683765_20240428201931A001.jpg','米家哈哈',NULL,NULL,NULL),(3,'华为','http://127.0.0.1:11032/statics/2024/04/28/1680088752542_20240428202054A002.jpg','哈哈哈',NULL,NULL,NULL),(4,'头宝','http://127.0.0.1:11032/statics/2024/04/28/1680501683765_20240428202327A003.jpg',NULL,NULL,NULL,NULL);
...
CREATE TABLE `pms_category_brand_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='品牌分类关联';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pms_category_brand_relation` VALUES (5,2,225,'小米','手机'),(6,2,165,'小米','电子书'),(8,3,225,'华为','手机');
...
-- Dump completed on 2024-07-12 16:06:30
